export default Hilo.Class.create({
  ...
  load(){
    const resources=[
      {id:'bg',src:require('../../assets/imgs/bird/bg.png')},
      {id:'ground', src:require('../../assets/imgs/bird/ground.png')},
      {id:'ready', src:require('../../assets/imgs/bird/ready.png')},
      {id:'over', src:require('../../assets/imgs/bird/over.png')},
      {id:'number',src:require('../../assets/imgs/bird/number.png')},
      {id:'bird', src:require('../../assets/imgs/bird/bird.png')},
      {id:'holdback', src:require('../../assets/imgs/bird/holdback.png')}
    ];
